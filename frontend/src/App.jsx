...
import HODAccountsPortal   from "./pages/HODAccountsPortal";   // ← NEW
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Department Admin Portal — HOD scoped to their department */}
        <Route path="/portal/hod" element={
          <ProtectedRoute role="HOD"><DeptPortal /></ProtectedRoute>
        }/>

        {/* HOD Accounts — HR read-only view + Mark Register */}
        <Route path="/portal/hod-accounts" element={
          <ProtectedRoute role="HOD_ACCOUNTS"><HODAccountsPortal /></ProtectedRoute>
        }/>
