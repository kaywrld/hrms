...
const NAV_ITEMS = [
  ...
  {
    key: "sites_departments", label: "Sites & Depts",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round">
        <path d="M3 21h18" /><path d="M5 21V7l7-4 7 4v14" /><path d="M9 9h1" /><path d="M14 9h1" /><path d="M9 13h1" /><path d="M14 13h1" /><path d="M9 21v-4h6v4" />
      </svg>
    ),
  },
  {
...
// Same bank list + "Other…" fallback behaviour as the Add Employee form
// (EmployeesPage.jsx's BankNameSelect), just restyled to match this modal.
function _EditBankSelect({ value, onChange }) {
    ...
    <>
      ...
      {showOther && (
        <div style={{ marginTop: 8 }}>
          <_EditInput value={value} onChange={onChange} placeholder="Enter bank name" />
        </div>
      )}
    </>
  );
            ...
            <>
              ...
              <div className="hr-modal-2col" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 16px" }}>
                <Field label="Bank Name">
                  <_EditBankSelect value={form.bank_name_usd} onChange={set("bank_name_usd")} />
                </Field>
              ...
              <div className="hr-modal-2col" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 16px" }}>
                <Field label="Bank Name">
                  <_EditBankSelect value={form.bank_name_zig} onChange={set("bank_name_zig")} />
                </Field>
                <Field label="Account Number">
          ...
          {tab === "employment" && (
            <>
              ...
              <div className="hr-modal-2col" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0 16px" }}>
                ...
                <Field label="Site">
                  <Select value={form.site} onChange={set("site")} placeholder="Select site"
...
function HRPortalInner() {
  const { user, isHRM, departments, sites } = useHRPortal();
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case "employees":  return (
        <HREmployeesPage showToast={showToast} isHRM={isHRM} onEditEmployee={handleDashboardEdit} />
      );
      case "sites_departments": return (
        <HRSitesDepartmentsPage showToast={showToast} isHRM={isHRM} />
      );
